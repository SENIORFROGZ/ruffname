...
// FileProvider fetches secrets from the file system.
type FileProvider struct {
	rootPath string
}

// NewFileProvider creates a new FileProvider from the given root directory.
func NewFileProvider(rootPath string) FileProvider {
	return FileProvider{rootPath: rootPath}
}

// Get fetches a secret.
func (fb *FileProvider) Get(secretID string) s.Secret {
