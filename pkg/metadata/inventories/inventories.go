...
const (
	...
	AgentSecurityEnabled    AgentMetadataName = "feature_security_enabled"
	...
	AgentComplianceEnabled  AgentMetadataName = "feature_compliance_enabled"
...
func InitializeData() {
	...
	SetAgentMetadata(AgentSecurityEnabled, config.Datadog.GetString("runtime_security_config.enabled"))
	SetAgentMetadata(AgentProcessEnabled, config.Datadog.GetString("process_config.enabled"))
	SetAgentMetadata(AgentNetworksEnabled, config.Datadog.GetString("system_probe_config.enabled"))
	SetAgentMetadata(AgentLogsEnabled, config.Datadog.GetString("logs_enabled"))
	SetAgentMetadata(AgentComplianceEnabled, config.Datadog.GetString("compliance_config.enabled"))
	SetAgentMetadata(AgentAPMEnabled, config.Datadog.GetString("apm_config.enabled"))
}
